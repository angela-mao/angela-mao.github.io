    ...
    return (
        <header className="header">
            ...
            <nav id="navBar" className="navBar">
                ...
                <a href="https://drive.google.com/file/d/1v3eC0xIGwtTskgA92re9Xjmp5o5_rYG4/view?usp=sharing" id="resume">Resume</a>
                <DropdownButton id="icon" title={<img className="menu" src={menu} alt="Menu"/>}>
                    ...
                    <Dropdown.Item href="https://drive.google.com/file/d/1v3eC0xIGwtTskgA92re9Xjmp5o5_rYG4/view?usp=sharing" id="item4">Resume</Dropdown.Item>
                </DropdownButton>
            </nav>
        </header>
    );
