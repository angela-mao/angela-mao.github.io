    ...
    return (
        <header className="header">
            ...
            <nav id="navBar" className="navBar">
                ...
                <a href="https://drive.google.com/file/d/17WMzSvjH4VK7YI4Zdz8_4m93bLmX3A9I/view?usp=sharing" id="resume">Resume</a>
                <DropdownButton id="icon" title={<img className="menu" src={menu} alt="Menu"/>}>
                    ...
                    <Dropdown.Item href="https://drive.google.com/file/d/17WMzSvjH4VK7YI4Zdz8_4m93bLmX3A9I/view?usp=sharing" id="item4">Resume</Dropdown.Item>
                </DropdownButton>
            </nav>
        </header>
    );
