    ...
    return (
        <header className="header">
            ...
            <nav id="navBar" className="navBar">
                ...
                <a href="https://drive.google.com/file/d/16n01RiXlHQ9_F6-GibhRJnH4Wl_pGZFG/view?usp=sharing" id="resume">Resume</a>
                <DropdownButton id="icon" title={<img className="menu" src={menu} alt="Menu"/>}>
                    ...
                    <Dropdown.Item href="https://drive.google.com/file/d/16n01RiXlHQ9_F6-GibhRJnH4Wl_pGZFG/view?usp=sharing" id="item4">Resume</Dropdown.Item>
                </DropdownButton>
            </nav>
        </header>
    );
